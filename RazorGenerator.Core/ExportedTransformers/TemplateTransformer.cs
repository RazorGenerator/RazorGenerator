...
namespace RazorGenerator.Core {
    ...
    public class TemplateCodeTransformer : AggregateCodeTransformer {
        ...
        private string _autoGeneratedBaseType; 
        ...
        public override void Initialize(RazorHost razorHost, IDictionary<string, string> directives) {
            ...
            _autoGeneratedBaseType = razorHost.DefaultClassName + "Base";
            razorHost.DefaultBaseClass = _autoGeneratedBaseType;
        }
        ...
        public override void ProcessGeneratedCode(CodeCompileUnit codeCompileUnit, CodeNamespace generatedNamespace, CodeTypeDeclaration generatedClass, CodeMemberMethod executeMethod) {
            ...
            var baseType = generatedClass.BaseTypes.OfType<CodeTypeReference>().FirstOrDefault();
            if (baseType != null && _autoGeneratedBaseType.Equals(baseType.BaseType, StringComparison.OrdinalIgnoreCase)) {
                // Only provide a base type implementation if it matches the auto-generated type.
