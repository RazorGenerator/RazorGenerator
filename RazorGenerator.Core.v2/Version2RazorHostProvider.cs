    ...
    public class Version2RazorHostProvider : IRazorHostProvider
    {
        public Boolean CanGetRazorHost( out String errorDetails )
        {
            ...
            try
            {
                ...
                // System.Web.Mvc            should be `[4.0.0,5.0.0)`
                // System.Web.Razor          should be `[2.0.0,3.0.0)`
                // System.Web.WebPages       should be `[2.0.0,3.0.0)`
                // System.Web.WebPages.Razor should be `[2.0.0,3.0.0)`
                ...
                Boolean ok = 
                    ...
                    systemWebMvcDll          .VersionIsInRange( new Version( 4, 0, 0 ), new Version( 5, 0, 0 ), out String err2 ) &
                    systemWebRazorDll        .VersionIsInRange( new Version( 2, 0, 0 ), new Version( 3, 0, 0 ), out String err3 ) &
                    systemWebWebPagesDll     .VersionIsInRange( new Version( 2, 0, 0 ), new Version( 3, 0, 0 ), out String err4 ) &
                    systemWebWebPagesRazorDll.VersionIsInRange( new Version( 2, 0, 0 ), new Version( 3, 0, 0 ), out String err5 );
